...
class Button:
    def __init__(self, coord_x, coord_y, width, height, text):
        ...
        self.color = (100, 100, 200) # Базовый цвет кнопки
        self.hover_color = (150, 150, 255) # Цвет при наведении курсора
        self.clicked_color = (200, 200, 255) # Цвет при клике на кнопку
        self.text_color = (255, 255, 255) # Цвет текста

        self.is_hovered = False # состояние наведения
        self.is_clicked = False # состояние клика
