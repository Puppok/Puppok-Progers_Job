...
class Slider:
    def __init__(self, coord_x, coord_y, width, min_val, max_val, init_value, label):
        ...
        self.handle_x = self.value_to_x(init_value)
        self.dragging = False
    ...
    def draw(self, surface):
        ...
        fill_rect = pg.Rect(self.rect.x, self.rect.y,
                            self.handle_x - self.rect.x, self.rect.height)
