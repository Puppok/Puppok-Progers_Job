...
# Формат данных
print(f'Data tain shape: {data_train.shape}\n'
...
for i in range(40):
      axes = ax[i // 10, i % 10] # разбиение диапазона range(40) на двумерный массив [row, col]
...
print(classification_report(
      ...
      predicted_classes, # пресказанные классы
...
sns.heatmap(conf_matrix, # матрица, на основе которой рисуем график
            ...
            cmap = 'Blues', # синяя цветовая схема (градиент от белого к темно синему (мало значений -> много значений))
